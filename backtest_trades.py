...
takeProfitSwingLows, takeProfitSwingHighs = get_previous_day_swings(security, spx_data["yesterdata"])
...
for simulated_time in this_generator:
    ...
    last_known_data_point, liquidity_lines, candidate_trades, takeProfitSwingLows, takeProfitSwingHighs = run_cycle(security, spx_data, current_time, last_known_data_point, liquidity_lines,
